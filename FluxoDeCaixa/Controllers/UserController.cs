...
namespace FluxoDeCaixa.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController( NHibernate.ISession session, Microsoft.AspNetCore.Http.IHttpContextAccessor contxt)
        {
        ...
        {
            var userInfo = JsonSerializer.Deserialize<Person>(_contxt.HttpContext.Session.GetString("User"));
            return View();
        }
